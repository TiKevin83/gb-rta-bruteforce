...
import stringflow.rta.gen1.data.Tile;
...
import stringflow.rta.gen1.OverworldTilePath;
...
public class AStar {
    ...
    public static OverworldTile[][] initTiles(Map targetMap, int numFramesPerStep, int sbcost, MapDestination... destinations) {
